...
import com.adeo.dp4p.sales.sofianetest.repository.OperatorInMemoryRepositoryAdapter;
...
public class OperatorRepositoryTest {
    @Autowired
    OperatorInMemoryRepositoryAdapter operatorInMemoryRepository;
   ...
   @Test
    void test_save_with_right_parameters() throws Exception{
       ...
       //when
       operatorInMemoryRepository.savememory(resultOperatorEntity.getResult(), resultOperatorEntity.getDate(), resultOperatorEntity.getOperator());
    ...
    void test_save_with_wrong_value_result() throws Exception {
           ...
           resultOperatorEntity.setOperator(operator);
            ...
            assertThrows(ObjectValueNullException.class, () ->
                    operatorInMemoryRepository.savememory(result, dateTest, operator));
    }
